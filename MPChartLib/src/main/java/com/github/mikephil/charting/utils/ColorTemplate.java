...
public class ColorTemplate {
    ...
    public static final int[] ORDER_RECEIVED_COLORS = {
            //order received        order confirmed   order out for delivery
            rgb("#efcb44"), rgb("#67983a"), rgb("#366797"), rgb("#3498db")
    };


    public static final int[] ORDER_DELIVERED_COLORS = {
            // order Deliverd     order Returned      order Canceled
            rgb("#010864"), rgb("#fc0d1b"), rgb("#651bc9"), rgb("#3498db")
    };
