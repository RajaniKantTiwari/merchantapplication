...
public class DashboardPresenter implements Presenter<MvpView> {
    ...
    public void getOrderReceivedChart(Activity activity) {
        ...
        mRepository.getOrderReceivedChart().subscribeOn(Schedulers.io()).
            ...
            public void onError(Throwable call, BaseResponse baseResponse) {
                mView.hideProgress();
                mView.onError(call, AppConstants.CHART_DATA);
            }
        });
    }
    ...
    public void getOrderReceived(Activity activity) {
        ...
        mRepository.getOrderReceived().subscribeOn(Schedulers.io()).
            ...
            public void onError(Throwable call, BaseResponse baseResponse) {
                mView.hideProgress();
                mView.onError(call, AppConstants.ORDER_DATA);
            }
        });
    }
    ...
    public void getDeliveryBoyList(DashBoardActivity activity) {
        ...
        mRepository.getDeliveryBoyList().subscribeOn(Schedulers.io()).
            ...
            public void onError(Throwable call, BaseResponse baseResponse) {
                mView.hideProgress();
                mView.onError(call, AppConstants.DELIVERY_BOY_DATA);
            }
        });
    }
    ...
    public void logout(DashBoardActivity activity) {
        ...
        mRepository.logout().subscribeOn(Schedulers.io()).
            ...
            public void onError(Throwable call, BaseResponse baseResponse) {
                mView.hideProgress();
                mView.onError(call, AppConstants.LOGOUT);
            }
        });
    }
    ...
    public void getAllOrder(DashBoardActivity activity) {
        ...
        mRepository.getAllOrder().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribeWith(new DefaultApiObserver<MyOrderData>(activity) {
            ...
            public void onError(Throwable call, BaseResponse baseResponse) {
                mView.hideProgress();
                mView.onError(call, AppConstants.ALL_ORDER);
            }
        });
    }
    ...
    public void addNewCustomer(NewCustomerRequest request, Activity activity) {
        ...
        mRepository.addNewCustomer(request).subscribeOn(Schedulers.io()).
                observeOn(AndroidSchedulers.mainThread()).subscribeWith(new DefaultApiObserver<NewCustomerResposeData>(activity) {
            @Override
            public void onResponse(NewCustomerResposeData response) {
                mView.hideProgress();
                mView.onSuccess(response, 1);
            }
    ...
    public void addProductToMerchantList(DashBoardActivity activity, MerchantProductListRequest request) {
        mView.showProgress();
        mRepository.addProductToMerchantList(request).subscribeOn(Schedulers.io()).
                observeOn(AndroidSchedulers.mainThread()).subscribeWith(new DefaultApiObserver<BaseResponse>(activity) {
            @Override
            public void onResponse(BaseResponse response) {
                mView.hideProgress();
    ...
    public void addOrderFeedback(DashBoardActivity activity, FeedBackRequest request) {
        mView.showProgress();
        mRepository.addOrderFeedback(request).subscribeOn(Schedulers.io()).
                observeOn(AndroidSchedulers.mainThread()).subscribeWith(new DefaultApiObserver<BaseResponse>(activity) {
            @Override
            public void onResponse(BaseResponse response) {
                mView.hideProgress();
                mView.onSuccess(response, 10);
            }

            @Override
            public void onError(Throwable call, BaseResponse baseResponse) {
                mView.hideProgress();
                mView.onError(call, 10);
            }
        });
    }

    public void getAllMerchantProduct(DashBoardActivity activity) {
        mView.showProgress();
        mRepository.getAllMerchantProduct().subscribeOn(Schedulers.io()).
            ...
            public void onResponse(AllMerchantData response) {
                mView.hideProgress();
                mView.onSuccess(response, 15);
            }

            @Override
            public void onError(Throwable call, BaseResponse baseResponse) {
                mView.hideProgress();
                mView.onError(call, 15);
            }
        });
    }
    ...
    public void updateMyInventory(DashBoardActivity activity, UpdateMyInventoryRequest request) {
        mView.showProgress();
        mRepository.updateMyInventory(request).subscribeOn(Schedulers.io()).
                observeOn(AndroidSchedulers.mainThread()).subscribeWith(new DefaultApiObserver<BaseResponse>(activity) {
            @Override
            public void onResponse(BaseResponse response) {
                mView.hideProgress();
