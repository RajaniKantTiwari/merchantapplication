...
import com.app.merchant.databinding.FragmentOrderDeliveryDetailsBinding;
...
public class OrderDetailsDeliveryFragment extends DashboardFragment implements OrderListAdapter.OrderListener {

    private FragmentOrderDeliveryDetailsBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_order_delivery_details, container, false);
    ...
    public void setListener() {
        mBinding.tvAddPayment.setOnClickListener(this);

    }

    @Override
    public String getFragmentName() {
        return OrderDetailsDeliveryFragment.class.getSimpleName();
    }
