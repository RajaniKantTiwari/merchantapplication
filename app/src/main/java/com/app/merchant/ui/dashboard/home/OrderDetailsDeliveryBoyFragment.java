...
public class OrderDetailsDeliveryBoyFragment extends DashboardFragment implements OrderListAdapter.OrderListener {

    private FragmentDeliveryOrderDetailsBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_delivery_order_details, container, false);
    ...
    public String getFragmentName() {
        return OrderDetailsDeliveryBoyFragment.class.getSimpleName();
    }
