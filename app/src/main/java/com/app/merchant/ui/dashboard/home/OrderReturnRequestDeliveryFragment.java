...
import com.app.merchant.databinding.FragmentOrderReturnRequestDetailsBinding;
...
public class OrderReturnRequestDeliveryFragment extends DashboardFragment implements OrderListAdapter.OrderListener {

    private FragmentOrderReturnRequestDetailsBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_order_return_request_details, container, false);
    ...
    public String getFragmentName() {
        return OrderReturnRequestDeliveryFragment.class.getSimpleName();
    }
